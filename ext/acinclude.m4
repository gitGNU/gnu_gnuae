dnl $Id: acinclude.m4,v 1.2 2009/11/25 01:01:01 rsavoye Exp $ -*- autoconf -*-
dnl
...
dnl choose the right compiler/flags/etc. for the source-file
	  ...
	  *.cc[)] ac_comp="$b_cxx_pre $3 $ac_inc $b_cxx_meta -c $ac_srcdir$ac_src -o $ac_bdir$ac_obj.$b_lo $6$b_cxx_post" ;;
      esac
