...
CREATE TABLE `batteries` (
  ...
  KEY `itemID` (`itemID`),
  KEY `itemID_2` (`itemID`)
) ENGINE=MyISAM AUTO_INCREMENT=300029 DEFAULT CHARSET=latin1;
...
INSERT INTO `centers` VALUES (0,'SW4024','\"Xantrax\"',4995,24),(0,'SW4048','\"Xantrax\"',4995,48),(0,'SW5548','\"Xantrax\"',5695,48),(0,'SW4024','\"Xantrax\"',8995,24),(0,'SW4048','\"Xantrax\"',9137,48),(0,'SW5548','\"Xantrax\"',9999,48),(0,'DR1512','\"Xantrax\"',1979,12),(0,'DR1512','\"Xantrax\"',3637,12),(0,'DR2412','\"Xantrax\"',2295,12),(0,'DR2412','\"Xantrax\"',4337,12),(0,'DR1524','\"Xantrax\"',1879,24),(0,'DR1524','\"Xantrax\"',3529,24),(0,'DR2424','\"Xantrax\"',2295,24);
...
INSERT INTO `loads` VALUES (50001,'Pressure Booster','Flowlight Pressure Booster','DC','HOUSEHOLD',24,180,0),(50002,'PC Speakers','Yamaha Speakers','AC','DIGITAL',120,4,0),(50003,'Nokia Charger','Nokia 5660 Cell Phone Charger','AC','DIGITAL',120,3,0),(50004,'Maxon Charger','Charger for Maxon 201+3','AC','DIGITAL',120,1,0),(50005,'Laser Printer','HP LaserJet 5MP','AC','DIGITAL',120,200,2),(50006,'Laptop','HP Omnibook6100 Laptop','AC','DIGITAL',120,24,0),(50007,'Glue Gun','Glue Gun','AC','TOOLS',120,5,0),(50008,'Gateway Laptop','gateway Solo 5150 Laptop','AC','DIGITAL',120,20,0),(50009,'ETA Pump','Dankoff ETA Deep Well Pump','DC','HOUSEHOLD',24,192,0),(50010,'Docking Station','Gateway Docking Station','AC','DIGITAL',120,34,0),(50011,'Dish Washer','Apartment Sized Dish Washer','AC','KITCHEN',120,687,6),(50012,'DC Lights','Compact Flourescent Light Bulb','DC','HOUSEHOLD',24,15,1),(50013,'Cordless Charger','Dewalt 18V Battery Charger','AC','TOOLS',120,70,0),(50014,'Coffee Grinder','Coffe Grinder','AC','KITCHEN',120,93,0),(50015,'Clothes Washer','','AC','HOUSEHOLD',120,18,0),(50016,'CD Player','Harmon Kardon CD Player','AC','HOUSEHOLD',120,18,0),(50017,'Blender','Blender','AC','HOUSEHOLD',120,531,0),(50018,'Alarm Clock','Clock/Radio','AC','HOUSEHOLD',120,1,0),(50019,'AC Lights','Compact Flourescent Light Bulb','AC','HOUSEHOLD',120,18,0),(50020,'21in CRT','Panisonic S21 CRT','AC','DIGITAL',120,103,1),(50021,'19ft Refridgerator','SunFrost 19','DC','HOUSEHOLD',24,696,29),(50022,'18in LCD Monitor','HP 1820 LCD Monitor','AC','DIGITAL',120,30,0),(50023,'16ft Refridgerator','SunFrost 16','DC','HOUSEHOLD',24,696,0),(50024,'133Mhz Pentium','133 Mgz Pentium PC','AC','DIGITAL',120,53,0),(50025,'12ft Refridgerator','SunFrost 12','DC','HOUSEHOLD',24,696,29),(50026,'SQ Flex Pump','Grundfos SQ Flex Deep Well Pump','DC','HOUSEHOLD',24,192,8),(50027,'Sewing Machine','Singer Sewing Machine','AC','TOOLS',120,51,0),(50028,'Stereo','Stereo/Amp','AC','HOUSEHOLD',120,18,0),(50029,'TV','','AC','HOUSEHOLD',120,18,0),(50030,'Tape Deck','Harmon Kardon Tape Deck','AC','HOUSEHOLD',120,18,0),(50031,'Terminal Server','Livingston Port Master','AC','DIGITAL',120,20,0),(50032,'Toaster Oven','Toaster Oven','AC','HOUSEHOLD',120,240,0),(50033,'US Robotics Modem','56K US Robotics Modem','AC','DIGITAL',120,4,0),(50034,'VCR','','AC','HOUSEHOLD',120,18,0),(50035,'Vacumn','Old Hoover Upright Vacumn','AC','HOUSEHOLD',120,800,7),(50036,'Wireless Phone','Telemobile PTEL Wireless Phone','DC','HOUSEHOLD',12,3,0),(50037,'Yaesu Charger','Charger for Yaesu FT51','AC','DIGITAL',120,1,0),(50038,'Zycel Modem','Zycel 1496+ Modem','AC','DIGITAL',120,6,0);
